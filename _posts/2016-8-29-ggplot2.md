...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/first_plot.png ){:class="img-responsive",width=200}
...
![alt tag](http://deveaup.github.io/images/first_ggplot.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_bw.png ){:class="img-responsive",width=200}


{% highlight R %}
ggplot(data = dataset, aes(x=C,y=D))+geom_point()+theme_classic()
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_classic.png ){:class="img-responsive",width=200}


{% highlight R %}
ggplot(data = dataset, aes(x=C,y=D))+geom_point()+theme_minimal()
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_minimal.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_bw_shifted.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored_discrete.png ){:class="img-responsive",width=200}
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_point()+theme_bw()+
			scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored_reordered.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored_shaped.png ){:class="img-responsive",width=200}
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_line()+theme_bw()+
			scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_line_test.png ){:class="img-responsive",width=200}
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_line(alpha = I(0.5))+theme_bw()+
			scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_line_alpha.png ){:class="img-responsive",width=200}
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_smooth(alpha = I(0.3))+geom_point()+theme_bw()+
  scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_smooth_each.png ){:class="img-responsive",width=200}
...
ggplot(data = dataset, aes(x=C,y=D))+geom_smooth(alpha = I(0.3))+geom_point(aes(color = A))+theme_bw()+
  scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_smooth_all.png ){:class="img-responsive",width=200}
...
ggplot(data = dataset, aes(x=C,y=D))+geom_density_2d()+geom_point(aes(color = A),alpha = I(0.3))+theme_bw()+
  scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_density.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/first_hist.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/color_hist_ggplot.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/fill_hist_ggplot.png ){:class="img-responsive",width=200}
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/gaussian.png ){:class="img-responsive",width=200}
