...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/first_plot.png | width=150)
...
![alt tag](http://deveaup.github.io/images/first_ggplot.png | width=150)
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_bw.png | width=150)


{% highlight R %}
ggplot(data = dataset, aes(x=C,y=D))+geom_point()+theme_classic()
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_classic.png | width=150)


{% highlight R %}
ggplot(data = dataset, aes(x=C,y=D))+geom_point()+theme_minimal()
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_minimal.png | width=150)
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/theme_bw_shifted.png | width=150)
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored.png | width=150)
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored_discrete.png | width=150)
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_point()+theme_bw()+
			scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored_reordered.png | width=150)
...
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_point_colored_shaped.png | width=150)
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_line()+theme_bw()+
			scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_line_test.png | width=150)
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_line(alpha = I(0.5))+theme_bw()+
			scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_line_alpha.png | width=150)
...
ggplot(data = dataset, aes(x=C,y=D,color = A))+geom_smooth(alpha = I(0.3))+geom_point()+theme_bw()+
  scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_smooth_each.png | width=150)
...
ggplot(data = dataset, aes(x=C,y=D))+geom_smooth(alpha = I(0.3))+geom_point(aes(color = A))+theme_bw()+
  scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_smooth_all.png | width=150)
...
ggplot(data = dataset, aes(x=C,y=D))+geom_density_2d()+geom_point(aes(color = A),alpha = I(0.3))+theme_bw()+
  scale_color_discrete("This is \n a legend")
{% endhighlight %}
![alt tag](http://deveaup.github.io/images/geom_density.png | width=150)
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/first_hist.png | width=150)
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/color_hist_ggplot.png | width=150)
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/fill_hist_ggplot.png | width=150)
...
{% endhighlight %}
 ![alt tag](http://deveaup.github.io/images/gaussian.png | width=150)
